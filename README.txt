...
* Check if settings.php have the setting enabled -> $settings['file_private_path'] = 'sites/default/files/private';
...
* Create private directory for demo module if it doesn't exist in 'sites/default/files/private/demo/'
...
* Enable atomatic reset from Dump settings (admin/structure/snapshots/demo/settings). Make sure you
